...
"}")
        ...
        self.baudrateList = QtWidgets.QComboBox(self.centralwidget)
        self.baudrateList.setObjectName("baudrateList")
        self.horizontalLayout_2.addWidget(self.baudrateList)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.verticalLayout_2.addLayout(self.verticalLayout)
        self.typeList = QtWidgets.QComboBox(self.centralwidget)
        self.typeList.setObjectName("typeList")
        self.verticalLayout_2.addWidget(self.typeList)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "SERIAL TERMINAL"))

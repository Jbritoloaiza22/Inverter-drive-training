...
/**
 * @brief stm32g031xx Interrupt Number Definition, according to the selected
...
typedef enum {
  ...
  DMA1_Ch4_5_DMAMUX1_OVR_IRQn =
      11, /*!< DMA1 Channel 4 to Channel 5 and DMAMUX1 Overrun Interrupts */
...
typedef struct {
  ...
  __IO uint32_t
      CR; /*!< Debug configuration register,    Address offset: 0x04 */
  __IO uint32_t
      APBFZ1; /*!< Debug APB freeze register 1,     Address offset: 0x08 */
  __IO uint32_t
      APBFZ2; /*!< Debug APB freeze register 2,     Address offset: 0x0C */
} DBG_TypeDef;
...
typedef struct {
  ...
  __IO uint32_t EXTICR[4]; /*!< EXTI External Interrupt Configuration Register,
                              0x60 -- 0x6C */
...
typedef struct {
  ...
  __IO uint32_t PCROP1ASR; /*!< FLASH Bank PCROP area A Start address register,
                              Address offset: 0x24 */
  ...
  __IO uint32_t WRP1BR; /*!< FLASH Bank WRP area B address register,    Address
                           offset: 0x30 */
  __IO uint32_t PCROP1BSR; /*!< FLASH Bank PCROP area B Start address register,
                              Address offset: 0x34 */
...
typedef struct {
  ...
  __IO uint32_t AHBENR; /*!< RCC AHB peripherals clock enable register,  Address
                           offset: 0x38 */
  ...
  __IO uint32_t APBENR2;  /*!< RCC APB peripherals clock enable register2,
                             Address offset: 0x40 */
  __IO uint32_t IOPSMENR; /*!< RCC IO port clocks enable in sleep mode register,
                             Address offset: 0x44 */
...
#define SRAM_SIZE_MAX                                                          \
  (0x00002000UL) /*!< maximum SRAM size (up to 8 KBytes)                       \
                  */
...
#define ADC_CFGR1_AWD1SGL                                                      \
  ADC_CFGR1_AWD1SGL_Msk /*!< ADC analog watchdog 1 monitoring a single channel \
                           or all channels */
...
#define ADC_CFGR2_TOVS                                                         \
  ADC_CFGR2_TOVS_Msk /*!< ADC oversampling discontinuous mode (triggered mode) \
...
#define ADC_CFGR2_CKMODE                                                       \
  ADC_CFGR2_CKMODE_Msk /*!< ADC clock source and prescaler (prescaler only for \
                          clock source synchronous) */
...
#define ADC_CHSELR_SQ_ALL                                                      \
  ADC_CHSELR_SQ_ALL_Msk /*!< ADC group regular sequencer all ranks, available  \
...
#define ADC_CCR_LFMEN                                                          \
  ADC_CCR_LFMEN_Msk /*!< Legacy feature, useless on STM32G0 (ADC common clock  \
                       low frequency mode is automatically managed by ADC      \
                       peripheral on STM32G0) */
...
#define DMAMUX_CxCR_DMAREQ_ID_Msk                                              \
  (0x3FUL << DMAMUX_CxCR_DMAREQ_ID_Pos)                 /*!< 0x0000003F */
...
#define FLASH_PCROP1ASR_PCROP1A_STRT_Msk                                       \
  (0x7FUL << FLASH_PCROP1ASR_PCROP1A_STRT_Pos) /*!< 0x0000007F */
...
#define FLASH_PCROP1AER_PCROP1A_END_Msk                                        \
  (0x7FUL << FLASH_PCROP1AER_PCROP1A_END_Pos) /*!< 0x0000007F */
...
#define FLASH_WRP1AR_WRP1A_STRT_Msk                                            \
  (0x1FUL << FLASH_WRP1AR_WRP1A_STRT_Pos) /*!< 0x0000001F */
#define FLASH_WRP1AR_WRP1A_STRT FLASH_WRP1AR_WRP1A_STRT_Msk
#define FLASH_WRP1AR_WRP1A_END_Pos (16U)
#define FLASH_WRP1AR_WRP1A_END_Msk                                             \
  (0x1FUL << FLASH_WRP1AR_WRP1A_END_Pos) /*!< 0x001F0000 */
...
#define FLASH_WRP1BR_WRP1B_END_Msk                                             \
  (0x1FUL << FLASH_WRP1BR_WRP1B_END_Pos) /*!< 0x001F0000 */
...
#define FLASH_PCROP1BSR_PCROP1B_STRT_Msk                                       \
  (0x7FUL << FLASH_PCROP1BSR_PCROP1B_STRT_Pos) /*!< 0x0000007F */
...
#define FLASH_PCROP1BER_PCROP1B_END_Msk                                        \
  (0x7FUL << FLASH_PCROP1BER_PCROP1B_END_Pos) /*!< 0x0000007F */
...
#define PWR_CR2_PVMEN_DAC_Msk                                                  \
  (0x1UL << PWR_CR2_PVMEN_DAC_Pos) /*!< 0x00000080 */
#define PWR_CR2_PVMEN_DAC                                                      \
  PWR_CR2_PVMEN_DAC_Msk /*!< DAC supply voltage monitoring enable */
...
#define PWR_SR2_PVMO_DAC_Msk                                                   \
  (0x1UL << PWR_SR2_PVMO_DAC_Pos) /*!< 0x00008000                              \
                                   */
#define PWR_SR2_PVMO_DAC                                                       \
  PWR_SR2_PVMO_DAC_Msk /*!< VDDA monitoring output flag */
...
#define RCC_CFGR_SW_HSISYS                                                     \
  (0x00000000UL) /*!< HSISYS oscillator selection as system clock */
#define RCC_CFGR_SW_HSE                                                        \
  (0x00000001UL) /*!< HSE oscillator selection as system clock */
#define RCC_CFGR_SW_PLLRCLK                                                    \
  (0x00000002UL) /*!< PLLRCLK selection as system clock */
#define RCC_CFGR_SW_LSI                                                        \
  (0x00000003UL) /*!< LSI oscillator selection as system clock */
#define RCC_CFGR_SW_LSE                                                        \
  (0x00000004UL) /*!< LSE oscillator selection as system clock */
...
#define SYSCFG_CFGR1_I2C1_FMP                                                  \
  SYSCFG_CFGR1_I2C1_FMP_Msk /*!< Enable Fast Mode Plus on PB10, PB11, PF6 and  \
                               PF7  */
...
#define SYSCFG_CFGR2_CLL                                                       \
  SYSCFG_CFGR2_CLL_Msk /*!< Enables and locks the LOCKUP (Hardfault) output of \
...
#define SYSCFG_CFGR2_PVDL                                                      \
  SYSCFG_CFGR2_PVDL_Msk /*!< Enables and locks the PVD connection with Timer1  \
                           Break Input and also the PVD_EN and PVDSEL[2:0]     \
...
#define TIM2_OR1_OCREF_CLR                                                     \
  TIM2_OR1_OCREF_CLR_Msk /*!<OCREF clear input selection */
...
#define USART_ISR_RXNE_RXFNE                                                   \
  USART_ISR_RXNE_RXFNE_Msk /*!< Read Data Register Not Empty/RXFIFO Not Empty  \
                            */

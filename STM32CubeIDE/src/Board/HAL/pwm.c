...
void vPWM_Init(PWM_t *self, uint32_t arr) {
  ...
  TIM1->CCMR1 = TIM_CCMR1_OC1M_2 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1PE |
                TIM_CCMR1_OC1FE | TIM_CCMR1_OC2M_2 | TIM_CCMR1_OC2M_1 |
                TIM_CCMR1_OC2PE | TIM_CCMR1_OC2FE;

  TIM1->CCMR2 =
      TIM_CCMR2_OC3M_2 | TIM_CCMR2_OC3M_1 | TIM_CCMR2_OC3PE | TIM_CCMR2_OC3FE |
 ...
 */
void vPWM_SetPhaseA(PWM_t *self, uint32_t duty) { TIM1->CCR1 = duty; }
 ...
 * @param duty Duty cycle value (0 to ARR).
 */
void vPWM_SetPhaseB(PWM_t *self, uint32_t duty) { TIM1->CCR2 = duty; }
 ...
 * @param duty Duty cycle value (0 to ARR).
 */
void vPWM_SetPhaseC(PWM_t *self, uint32_t duty) { TIM1->CCR3 = duty; }
 ...
 */
void vPWM_EnablePhaseA(PWM_t *self) { TIM1->CCER |= TIM_CCER_CC1E; }

/**
 * @brief Enables Phase B output (CH2 + CH2N).
 */
void vPWM_EnablePhaseB(PWM_t *self) { TIM1->CCER |= TIM_CCER_CC2E; }

/**
 * @brief Enables Phase C output (CH3 + CH3N).
 */
void vPWM_EnablePhaseC(PWM_t *self) { TIM1->CCER |= TIM_CCER_CC3E; }

/**
 * @brief Disables Phase A output.
 */
void vPWM_DisablePhaseA(PWM_t *self) { TIM1->CCER &= ~TIM_CCER_CC1E; }

/**
 * @brief Disables Phase B output.
 */
void vPWM_DisablePhaseB(PWM_t *self) { TIM1->CCER &= ~TIM_CCER_CC2E; }

/**
 * @brief Disables Phase C output.
 */
void vPWM_DisablePhaseC(PWM_t *self) { TIM1->CCER &= ~TIM_CCER_CC3E; }
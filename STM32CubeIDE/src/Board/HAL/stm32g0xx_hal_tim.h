...
#define TIM_OCMODE_COMBINED_1           (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_2)                     /*!< Combined  mode 1                    */
#define TIM_OCMODE_COMBINED_2           (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_0 | TIM_CCMR1_OC1M_2)  /*!< Combined  mode 2                    */
#define TIM_OCMODE_ASYMMETRIC_1         (TIM_CCMR1_OC1M_3 | TIM_CCMR1_OC1M_1 | TIM_CCMR1_OC1M_2)  /*!< Asymmetric  mode 1                  */
#define TIM_OCMODE_ASYMMETRIC_2         TIM_CCMR1_OC1M                                            /*!< Asymmetric  mode 2                  */
/**
  * @}
  */
...
#define IS_TIM__MODE(__MODE__) (((__MODE__) == TIM_OCMODE_1)               || \
                                   ...
                                   ((__MODE__) == TIM_OCMODE_COMBINED_1)      || \
                                   ((__MODE__) == TIM_OCMODE_COMBINED_2)      || \
                                   ((__MODE__) == TIM_OCMODE_ASYMMETRIC_1)    || \
                                   ((__MODE__) == TIM_OCMODE_ASYMMETRIC_2))
...
/* Non-Blocking mode: DMA */
HAL_StatusTypeDef HAL_TIM__Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, const uint32_t *pData,
                                        uint16_t Length);
...
HAL_StatusTypeDef HAL_TIM_OC_ConfigChannel(TIM_HandleTypeDef *htim, const TIM_OC_InitTypeDef *sConfig,
                                           uint32_t Channel);
HAL_StatusTypeDef HAL_TIM__ConfigChannel(TIM_HandleTypeDef *htim, const TIM_OC_InitTypeDef *sConfig,
                                            uint32_t Channel);

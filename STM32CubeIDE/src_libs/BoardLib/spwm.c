 ...
 * strategy for driving a three-phase inverter used in PMSM or BLDC motor
 * control.
 *
 ...
 */
void cbSPWM(void) { vSPWM_Init(&spwm, 0.06f, (uint32_t)TIM1->ARR); }
...
clean-src_libs-2f-BoardLib:
	-$(RM) ./src_libs/BoardLib/Itrip.cyclo ./src_libs/BoardLib/Itrip.d ./src_libs/BoardLib/Itrip.o ./src_libs/BoardLib/Itrip.su ./src_libs/BoardLib/Temperature.cyclo ./src_libs/BoardLib/Temperature.d ./src_libs/BoardLib/Temperature.o ./src_libs/BoardLib/Temperature.su ./src_libs/BoardLib/spwm.cyclo ./src_libs/BoardLib/spwm.d ./src_libs/BoardLib/spwm.o ./src_libs/BoardLib/spwm.su ./src_libs/BoardLib/svm.cyclo ./src_libs/BoardLib/svm.d ./src_libs/BoardLib/svm.o ./src_libs/BoardLib/svm.su

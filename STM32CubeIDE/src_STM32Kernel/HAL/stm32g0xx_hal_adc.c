...
HAL_StatusTypeDef HAL_ADC_Init(ADC_HandleTypeDef *hadc) {
  ...
  if (((hadc->State & HAL_ADC_STATE_ERROR_INTERNAL) == 0UL) &&
    ...
    if (LL_ADC_IsEnabled(hadc->Instance) == 0UL) {
      ...
      /* Update setting of discontinuous mode only if continuous mode is
       * disabled */
      ...
      MODIFY_REG(hadc->Instance->CFGR1,
                 ADC_CFGR1_RES | ADC_CFGR1_DISCEN | ADC_CFGR1_CHSELRMOD |
                     ADC_CFGR1_AUTOFF | ADC_CFGR1_WAIT | ADC_CFGR1_CONT |
                     ADC_CFGR1_OVRMOD | ADC_CFGR1_EXTSEL | ADC_CFGR1_EXTEN |
...
HAL_StatusTypeDef HAL_ADC_DeInit(ADC_HandleTypeDef *hadc) {
  ...
  hadc->Instance->CFGR1 &=
      ~(ADC_CFGR1_AWD1CH | ADC_CFGR1_AWD1EN | ADC_CFGR1_AWD1SGL |
        ADC_CFGR1_DISCEN | ADC_CFGR1_CHSELRMOD | ADC_CFGR1_AUTOFF |
        ADC_CFGR1_WAIT | ADC_CFGR1_CONT | ADC_CFGR1_OVRMOD | ADC_CFGR1_EXTEN |
